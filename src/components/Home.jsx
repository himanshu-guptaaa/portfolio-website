  ...
  return (
    <div className="relative h-screen overflow-hidden">
      ...
      <div className="relative z-10 flex flex-col items-center justify-center h-full text-blue-200 bg-black bg-opacity-50">
        <h2 ref={himanshuRef} className="text-6xl font-bold italic">HIMANSHU</h2>
        <h2 ref={guptaRef} className="text-4xl font-bold italic">GUPTA</h2>
        <p ref={taglineRef} className="mt-4 text-3xl italic">DEVELOPER, LOVE, STARTUP</p>
        <a 
          ref={buttonRef} 
          href="#projects" 
          className="mt-8 inline-block bg-blue-900 text-blue-100 py-2 px-4 rounded border-50% italic hover:bg-blue-400 p-2 rounded-lg"
        >
          Let's explore
        </a>
      </div>
